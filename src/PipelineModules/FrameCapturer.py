...
class FrameCapturer:
    frame_queue = queue.Queue(
        maxsize=FRAME_CAPTURER_QUEUE_SIZE)  # own buffer to make the capture process nonBlocking as it is the bottleneck of the pipeline (opencv buffer not controllable in that manner)
    frame_index = 0
    """
